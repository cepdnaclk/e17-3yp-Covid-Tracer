"""
Django settings for covid_tracer_backEnd project.
...
SECRET_KEY = 'django-insecure-!gt9r!8d8dmt_x4u%+*(#c7t_-y54+4dhibkj=(ysni!@c67c('
...
ROOT_URLCONF = 'covid_tracer_backEnd.urls'
